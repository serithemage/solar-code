...
export const GEMINI_CONFIG_DIR = '.solar';
export const DEFAULT_CONTEXT_FILENAME = 'SOLAR.md';
export const MEMORY_SECTION_HEADER = '## Solar Added Memories';

// This variable will hold the currently configured filename for SOLAR.md context files.
